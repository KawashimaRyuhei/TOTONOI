...
## 制作背景
利用したことのない店舗でも事前に得たい情報を得られるようにしたい。ということでこのアプリケーションを作成しました。「どこよりも詳細なサウナ情報」をモットーにしています。
...
## DEMO
### トップページ
![トップページ](https://user-images.githubusercontent.com/58518385/138257376-087b3b73-6e16-4b44-8a95-1939aed84724.gif)
  
トップページ兼一覧ページです。このページから店舗検索や店舗詳細ページに遷移することができます。
また開発途中ですが、店舗画像がトップページでスライド表示されるようにしています。
...
## 課題や今後実装したい機能   
ログイン機能もメールアドレスによるログインのみなので、GoogleやSNSアカウントでのログインを追加したいと考えています。  
...
現在、全体的に動きのないサイトなのでJavaScriptをさらに使って動きのあるサイトに改善中です。
